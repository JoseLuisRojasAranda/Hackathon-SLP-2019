...
exports.Row = ({ title, subtitle, onPress, showDisclosureIndicator, renderAccessory, titleStyles, subtitleStyles, isFirst, isLast, }) => {
    ...
    return (React.createElement(Container, { height: subtitle ? 56 : 46 },
        ...
        React.createElement(ContentContainer, { style: styles.contentContainer, onPress: onPress },
